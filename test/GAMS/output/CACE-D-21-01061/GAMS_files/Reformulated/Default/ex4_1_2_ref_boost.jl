...
function build_model()
    ...
    @constraint(model, E1, - X0 - 500*X1 + 2.5*X2 + 1.66667*X3 + X4 + 0.833333*X5 + X6 - 43.6364*X7 + 0.416667*X8 + 0.277778*X9 + 0.263158*X10 + 0.25*X11 + 0.238095*X12 + 0.227273*X13 + 0.217391*X14 + 0.208333*X15 + 0.2*X16 + 0.131579*X17 + 0.125*X18 + 0.119048*X19 + 0.108696*X20 + 1.25*X1*X3 + 0.714286*X1*X5 + 0.384615*X1*X8 + 0.192308*X1*X16 + 0.128205*X1*X17 + 0.121951*X1*X18 + 0.116279*X1*X19 + 0.106383*X1*X20 + 0.625*X2*X5 + 0.357143*X2*X8 + 0.185185*X2*X16 + 0.555556*X3*X5 + 0.333333*X3*X8 + 0.178571*X3*X16 + 0.3125*X4*X7 + 0.294118*X4*X8 + 0.344828*X4*X15 + 0.666667*X4*X16 - 15.4839*X5*X16 + 0.15625*X6*X13 + 0.151515*X6*X14 + 0.147059*X6*X15 + 0.142857*X6*X16 + 0.138889*X7*X16 + 0.135135*X8*X16 + 0.113636*SQR(X13) + 0.111111*X13*X14 + 0.208333*SQR(X15) + 0.408163*X15*X16 + 0.8*SQR(X16) == 0)

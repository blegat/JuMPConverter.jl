...
@variable(model, 0.26 <= X7 <= 2.15)
@variable(model, 0.26 <= X8 <= 2.81)
@variable(model, 0.28 <= X9 <= 2.78)
@variable(model, 0 <= X5 <= 38.22830000000001)
@variable(model, 0.39 <= X10 <= 2.19)
@variable(model, 0.62 <= X11 <= 2.94)
@variable(model, 0.52 <= X12 <= 2.62)
@variable(model, 0 <= X6 <= 20.84220000000001)
@variable(model, -14416.76647312631 <= X0 <= 73445.10350283327)
@variable(model, 0.125736 <= X70 <= 16.869132)
@variable(model, 0.01760304 <= X79 <= 38.4835122)
@variable(model, 0.03269136 <= X85 <= 47.40226092000001)
@variable(model, 0.1612 <= X44 <= 6.321)
...
@variable(model, 0.028392 <= X66 <= 17.107842)
@variable(model, 0.009842559999999998 <= X78 <= 44.00386940000001)
@variable(model, 0.02598543999999999 <= X83 <= 68.25072996000002)
@variable(model, 0.02347072 <= X84 <= 60.17273304000001)
@variable(model, 0.10394176 <= X92 <= 59.33312784000002)
@variable(model, 0.14776336 <= X91 <= 74.71182096000003)
@variable(model, 0.026364 <= X61 <= 13.230885)
@variable(model, 0.01028196 <= X73 <= 22.16997225)
@variable(model, 0.01173536 <= X77 <= 49.37838780000001)
@variable(model, 0.07311615999999999 <= X93 <= 47.11998736000001)
@variable(model, 0.037856 <= X65 <= 15.65974)
@variable(model, 0.06759999999999999 <= X40 <= 4.6225)
@variable(model, 0.052728 <= X68 <= 16.123218)
@variable(model, 0.06759999999999999 <= X41 <= 6.0415)
@variable(model, 0.07840000000000001 <= X50 <= 7.7284)
@variable(model, 0.004569759999999999 <= X72 <= 36.49972225000001)
@variable(model, 0.0728 <= X42 <= 5.976999999999999)
@variable(model, 0.018928 <= X60 <= 12.85055)
@variable(model, 0.01827904 <= X75 <= 31.73068900000001)
@variable(model, 0.1014 <= X43 <= 4.7085)
@variable(model, 0.02598543999999999 <= X74 <= 39.95504100000002)
@variable(model, 0.01476384 <= X80 <= 34.2948306)
@variable(model, 0.004569759999999999 <= X81 <= 62.34839521000001)
@variable(model, 0.1352 <= X45 <= 5.633)
@variable(model, 0.02119936 <= X88 <= 53.05082896)
@variable(model, 0.06759999999999999 <= X46 <= 7.896100000000001)
@variable(model, 0.035152 <= X62 <= 15.82873)
@variable(model, 0.105456 <= X71 <= 15.033036)
@variable(model, 0.007381919999999998 <= X76 <= 36.78186030000001)
@variable(model, 0.0728 <= X47 <= 7.8118)
@variable(model, 0.1736 <= X52 <= 8.1732)
@variable(model, 0.3844 <= X57 <= 8.643600000000001)
@variable(model, 0.00529984 <= X82 <= 61.02421924000001)
@variable(model, 0.1014 <= X48 <= 6.1539)
@variable(model, 0.01192464 <= X87 <= 37.06617924)
@variable(model, 0.1352 <= X49 <= 7.362200000000001)
@variable(model, 0.08382399999999998 <= X69 <= 21.644868)
@variable(model, 0.028392 <= X63 <= 13.08963)
@variable(model, 0.045136 <= X64 <= 17.57238)
...
@variable(model, 0.037856 <= X67 <= 20.466916)
@variable(model, -0 <= X1 <= 176.5064188900002)
@variable(model, -0 <= X2 <= 2634.385872687004)
@variable(model, -0 <= X3 <= 20560.72592440659)

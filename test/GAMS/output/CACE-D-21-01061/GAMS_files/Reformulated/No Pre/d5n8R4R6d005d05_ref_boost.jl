...
@variable(model, 0.9477572254335257 <= X15 <= 2.252323699421966)
@variable(model, 0.5600000000000001 <= X16 <= 2.81)
@variable(model, 0 <= X6 <= 0)
@variable(model, 0.12 <= X10 <= 2.55)
@variable(model, 0.59 <= X12 <= 2.3)
@variable(model, 0.9542554548485087 <= X13 <= 2.105741488297786)
@variable(model, 0 <= X7 <= 0)
@variable(model, 0.85 <= X17 <= 2.38)
@variable(model, 0 <= X8 <= 0)
@variable(model, 0 <= X9 <= 29.48614226760681)
@variable(model, -2404.941457722681 <= X0 <= 17841.17871509247)
@variable(model, 0.004515839999999999 <= X108 <= 51.34439025)
@variable(model, 0.102 <= X68 <= 6.069)
@variable(model, 0.0671012115606936 <= X92 <= 13.20987849710983)
@variable(model, 0.3480999999999999 <= X73 <= 5.29)
@variable(model, 0.3059999999999999 <= X83 <= 5.712)
@variable(model, 0.013452 <= X89 <= 13.78275)
@variable(model, 0.3169810689889414 <= X112 <= 23.45663877019907)
@variable(model, 0.8068418494353115 <= X115 <= 25.73494393007772)
@variable(model, 0.8179438860616443 <= X114 <= 22.49426053513972)
...
@variable(model, 0.02608224999999999 <= X111 <= 31.28164900000001)
@variable(model, 0.2816892426221522 <= X116 <= 40.05661561914182)
@variable(model, 0.7224999999999999 <= X88 <= 5.6644)
@variable(model, 0.8291986852365963 <= X113 <= 19.66166152906851)
@variable(model, 0.0144 <= X61 <= 6.5025)
@variable(model, 0.9044025022420297 <= X79 <= 4.742811458949188)
@variable(model, 0.3411926011560692 <= X81 <= 5.405576878612719)
@variable(model, 0.03671999999999999 <= X94 <= 14.5656)
@variable(model, 0.0966712369942196 <= X96 <= 13.66935253179191)
@variable(model, 0.4511324393063582 <= X106 <= 15.06309043699423)
@variable(model, 0.0228 <= X62 <= 5.992500000000001)
@variable(model, 0.1813085364212166 <= X70 <= 4.948492497499799)
@variable(model, 0.1800738728323699 <= X71 <= 5.292960693641621)
@variable(model, 0.9106034731081342 <= X77 <= 4.434147215538577)
@variable(model, 0.3131389872832369 <= X101 <= 14.55676806936417)
@variable(model, 0.1923778996974593 <= X103 <= 14.20112059708027)
@variable(model, 0.114510654581821 <= X64 <= 5.369640795159355)
...
@variable(model, 0.475300248554913 <= X102 <= 12.32921993063584)
@variable(model, 0.02548799999999999 <= X91 <= 14.076)
@variable(model, 0.2124 <= X74 <= 5.52)
@variable(model, 0.8982437583614548 <= X84 <= 5.072962046977852)
@variable(model, 0.1541122559580341 <= X98 <= 11.77741214404952)
@variable(model, 0.2920021691836436 <= X104 <= 12.02799538115696)
@variable(model, 0.06017999999999998 <= X93 <= 13.9587)
@variable(model, 0.3435319637454631 <= X78 <= 5.053779571914688)
@variable(model, 0.118944 <= X100 <= 15.5112)
@variable(model, 0.06368928554913292 <= X95 <= 16.1390254682081)
@variable(model, 0.8111171366212323 <= X80 <= 5.011664742148731)
@variable(model, 0.2016 <= X82 <= 6.744000000000001)
@variable(model, 0.008207999999999998 <= X90 <= 14.382)
@variable(model, 0.06482659421965314 <= X99 <= 12.70310566473989)
@variable(model, 0.2900137109826588 <= X105 <= 12.86527297109827)
@variable(model, 0.476 <= X87 <= 6.6878)
@variable(model, 0.1718364754259856 <= X97 <= 11.14560692853059)
@variable(model, 0 <= X1 <= 47.34151542996096)
@variable(model, -0 <= X2 <= 284.9006837418175)
@variable(model, -0 <= X3 <= 3355.273914194644)
@variable(model, -0 <= X4 <= 14675.68996313759)
@variable(model, 0.1137308670520231 <= X66 <= 5.743425433526014)
@variable(model, 0.5307440462427744 <= X85 <= 6.329029595375726)
@variable(model, 0.1615 <= X72 <= 5.593)
@variable(model, 0.5591767630057801 <= X75 <= 5.180344508670522)

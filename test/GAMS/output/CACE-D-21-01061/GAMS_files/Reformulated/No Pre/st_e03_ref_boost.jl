...
function build_model()
    ...
    @constraint(model, E4, - X0 + 5.04*X8 + 0.035*X9 + 10*X10 + 3.36*X12 - 0.063*X11*X14 == 0)
    @constraint(model, E5, - X4 - 0.325*X13 + X14 - 1.098*X15 + 0.038*SQR(X15) == 57.425)
    @constraint(model, E6, - X5 - 98000*X10 + 1000*X10*X13 + X16*X25 == 0)
    @constraint(model, E7, - X6 + X9 + X12 - X8*X15 == 0)
    @constraint(model, E8, - X7 + 1.12*X8 - X11 + 0.13167*X8*X15 - 0.00667*X8*X26 == 0)

...
@variable(model, -19617.75042950218 <= X0 <= 18554.162)
@variable(model, 1 <= X9 <= 16000)
@variable(model, 0.01267629025139401 <= X10 <= 120)
@variable(model, 0 <= X4 <= 0)
@variable(model, 85 <= X13 <= 93)
@variable(model, 5.689006069151149 <= X15 <= 12)
@variable(model, 0 <= X5 <= 0)
@variable(model, 85 <= X25 <= 304918.0327868853)
@variable(model, 0 <= X6 <= 0)
@variable(model, 0 <= X7 <= 5398.864126854693)
@variable(model, 32.3647900548386 <= X26 <= 144)

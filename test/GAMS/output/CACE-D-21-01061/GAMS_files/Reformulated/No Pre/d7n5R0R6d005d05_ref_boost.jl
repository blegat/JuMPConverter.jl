...
@variable(model, 0 <= X5 <= 21.363)
@variable(model, 0.08 <= X6 <= 2.71)
@variable(model, 0.87 <= X7 <= 2.84)
@variable(model, 0.42 <= X8 <= 2.2)
@variable(model, 0.06 <= X9 <= 2.15)
@variable(model, 0.6308048289738426 <= X10 <= 2.78)
@variable(model, -4589.852193358165 <= X0 <= 62045.65412420679)
...
@variable(model, 5.156974930047073e-06 <= X61 <= 165.1366353025001)
@variable(model, 0.003666544703999998 <= X56 <= 477.7623716661761)
@variable(model, 0.002062431395999999 <= X59 <= 300.7116682816001)
@variable(model, 0.1764 <= X28 <= 4.840000000000002)
@variable(model, 0.1583361341469362 <= X55 <= 59.72816656)
@variable(model, 4.064255999999997e-06 <= X57 <= 164.3088148900001)
@variable(model, 0.06300428042564202 <= X62 <= 461.603162442304)
@variable(model, 0.0048 <= X23 <= 5.8265)
@variable(model, 0.021924 <= X38 <= 13.4332)
@variable(model, 0.0696 <= X21 <= 7.6964)
@variable(model, 0.04541399999999999 <= X37 <= 17.34104)
@variable(model, 0.002724839999999999 <= X51 <= 37.28323600000001)
@variable(model, 1.295999999999999e-05 <= X54 <= 21.36750625000001)
@variable(model, 0.0336 <= X22 <= 5.962000000000001)
@variable(model, 0.230496084507042 <= X39 <= 17.36944)
@variable(model, 0.3979147322567188 <= X31 <= 7.7284)
@variable(model, 0.3653999999999999 <= X25 <= 6.248)
@variable(model, 0.1335171599999999 <= X50 <= 39.03750400000001)
@variable(model, 0.3011816608451104 <= X52 <= 62.33418304)
@variable(model, 0.548800201207243 <= X27 <= 7.895199999999999)
@variable(model, 0.01589628169014083 <= X41 <= 13.1494)
@variable(model, 0.03111695999999999 <= X53 <= 23.42560000000002)
@variable(model, 0.002546654286443 <= X49 <= 56.75814244)
@variable(model, 0.0252 <= X29 <= 4.73)
@variable(model, 0.002270897384305833 <= X43 <= 12.85055)
@variable(model, 0.02923199999999999 <= X33 <= 16.93208)
@variable(model, 2.303999999999999e-05 <= X48 <= 33.94810225000001)
@variable(model, 0.04390401609657944 <= X34 <= 21.395992)
@variable(model, 0.03292801207243458 <= X40 <= 16.97468)
@variable(model, 4.095999999999999e-05 <= X45 <= 53.93580481000001)
@variable(model, 0.004844159999999998 <= X46 <= 59.23457296)
@variable(model, 0.00112896 <= X47 <= 35.54544400000002)
@variable(model, 0 <= X1 <= 33.22117000000001)
@variable(model, -0 <= X2 <= 139.3940084527768)
@variable(model, -0 <= X3 <= 507.5787532777006)
@variable(model, -0 <= X4 <= 2747.946973348283)
@variable(model, 0.2510065346273718 <= X44 <= 21.484952)
@variable(model, 0.0522 <= X26 <= 6.106)
@variable(model, 0.003599999999999999 <= X30 <= 4.6225)
@variable(model, 0.06055199999999999 <= X32 <= 21.857776)
@variable(model, 0.000288 <= X36 <= 12.526975)
@variable(model, 0.05046438631790741 <= X24 <= 7.533799999999999)
@constraint(
    model,
    E1,

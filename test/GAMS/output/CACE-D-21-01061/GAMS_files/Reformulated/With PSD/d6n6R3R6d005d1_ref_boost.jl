...
@constraint(model, E55, - 2*X12 + SQR(X12) >= -1)
@constraint(model, E56, 2*X12 + SQR(X12) >= -1)
@constraint(model, E57, - 2*X13 + SQR(X13) >= -1)
@constraint(model, E58, 2*X13 + SQR(X13) >= -1)
@constraint(model, E59, - 2*X14 + SQR(X14) >= -1)
@constraint(model, E60, 2*X14 + SQR(X14) >= -1)
@constraint(model, E61, - 2*X59 + SQR(X59) >= -1)
@constraint(model, E62, 2*X59 + SQR(X59) >= -1)
@constraint(model, E63, - 2*X60 + SQR(X60) >= -1)
@constraint(model, E64, 2*X60 + SQR(X60) >= -1)
@constraint(model, E65, - 2*X62 + SQR(X62) >= -1)
@constraint(model, E66, 2*X62 + SQR(X62) >= -1)
@constraint(model, E67, - 2*X64 + SQR(X64) >= -1)
@constraint(model, E68, 2*X64 + SQR(X64) >= -1)
@constraint(model, E69, - 2*X65 + SQR(X65) >= -1)
@constraint(model, E70, 2*X65 + SQR(X65) >= -1)
@constraint(model, E71, - 2*X66 + SQR(X66) >= -1)
@constraint(model, E72, 2*X66 + SQR(X66) >= -1)
@constraint(model, E73, - 2*X68 + SQR(X68) >= -1)
@constraint(model, E74, 2*X68 + SQR(X68) >= -1)
@constraint(model, E75, - 2*X70 + SQR(X70) >= -1)
@constraint(model, E76, 2*X70 + SQR(X70) >= -1)
@constraint(model, E77, - 2*X71 + SQR(X71) >= -1)
@constraint(model, E78, 2*X71 + SQR(X71) >= -1)
@constraint(model, E79, - 2*X72 + SQR(X72) >= -1)
@constraint(model, E80, 2*X72 + SQR(X72) >= -1)
@constraint(model, E81, - 2*X73 + SQR(X73) >= -1)
@constraint(model, E82, 2*X73 + SQR(X73) >= -1)
@constraint(model, E83, - 2*X75 + SQR(X75) >= -1)
@constraint(model, E84, 2*X75 + SQR(X75) >= -1)
@constraint(model, E85, - 2*X77 + SQR(X77) >= -1)
@constraint(model, E86, 2*X77 + SQR(X77) >= -1)
@constraint(model, E87, - 2*X78 + SQR(X78) >= -1)
@constraint(model, E88, 2*X78 + SQR(X78) >= -1)
@constraint(model, E89, - 2*X81 + SQR(X81) >= -1)
@constraint(model, E90, 2*X81 + SQR(X81) >= -1)
@constraint(model, E91, SQR(X9) - 2*X9*X11 + SQR(X11) >= 0)
@constraint(model, E92, SQR(X9) + 2*X9*X11 + SQR(X11) >= 0)
@constraint(model, E93, SQR(X9) - 2*X9*X12 + SQR(X12) >= 0)
@constraint(model, E94, SQR(X9) + 2*X9*X12 + SQR(X12) >= 0)
@constraint(model, E95, SQR(X9) - 2*X9*X13 + SQR(X13) >= 0)
@constraint(model, E96, SQR(X9) + 2*X9*X13 + SQR(X13) >= 0)
@constraint(model, E97, SQR(X9) - 2*X9*X14 + SQR(X14) >= 0)
@constraint(model, E98, SQR(X9) + 2*X9*X14 + SQR(X14) >= 0)
@constraint(model, E99, SQR(X9) - 2*X9*X71 + SQR(X71) >= 0)
@constraint(model, E100, SQR(X9) + 2*X9*X71 + SQR(X71) >= 0)
@constraint(model, E101, SQR(X9) - 2*X9*X78 + SQR(X78) >= 0)
@constraint(model, E102, SQR(X9) + 2*X9*X78 + SQR(X78) >= 0)
@constraint(model, E103, SQR(X11) - 2*X11*X13 + SQR(X13) >= 0)
@constraint(model, E104, SQR(X11) + 2*X11*X13 + SQR(X13) >= 0)
@constraint(model, E105, SQR(X11) - 2*X11*X14 + SQR(X14) >= 0)
@constraint(model, E106, SQR(X11) + 2*X11*X14 + SQR(X14) >= 0)
@constraint(model, E107, SQR(X11) - 2*X11*X62 + SQR(X62) >= 0)
@constraint(model, E108, SQR(X11) + 2*X11*X62 + SQR(X62) >= 0)
@constraint(model, E109, SQR(X12) - 2*X12*X13 + SQR(X13) >= 0)
@constraint(model, E110, SQR(X12) + 2*X12*X13 + SQR(X13) >= 0)
@constraint(model, E111, SQR(X12) - 2*X12*X14 + SQR(X14) >= 0)
@constraint(model, E112, SQR(X12) + 2*X12*X14 + SQR(X14) >= 0)
@constraint(model, E113, SQR(X13) - 2*X13*X14 + SQR(X14) >= 0)
@constraint(model, E114, SQR(X13) + 2*X13*X14 + SQR(X14) >= 0)
@constraint(model, E115, SQR(X13) - 2*X13*X65 + SQR(X65) >= 0)
@constraint(model, E116, SQR(X13) + 2*X13*X65 + SQR(X65) >= 0)
@constraint(model, E117, SQR(X60) - 2*X60*X68 + SQR(X68) >= 0)
@constraint(model, E118, SQR(X60) + 2*X60*X68 + SQR(X68) >= 0)
@constraint(model, E119, SQR(X60) - 2*X60*X72 + SQR(X72) >= 0)
@constraint(model, E120, SQR(X60) + 2*X60*X72 + SQR(X72) >= 0)
@constraint(model, E121, SQR(X60) - 2*X60*X75 + SQR(X75) >= 0)
@constraint(model, E122, SQR(X60) + 2*X60*X75 + SQR(X75) >= 0)
@constraint(model, E123, SQR(X62) - 2*X62*X71 + SQR(X71) >= 0)
@constraint(model, E124, SQR(X62) + 2*X62*X71 + SQR(X71) >= 0)
@constraint(model, E125, SQR(X65) - 2*X65*X73 + SQR(X73) >= 0)
@constraint(model, E126, SQR(X65) + 2*X65*X73 + SQR(X73) >= 0)
@constraint(model, E127, SQR(X68) - 2*X68*X81 + SQR(X81) >= 0)
@constraint(model, E128, SQR(X68) + 2*X68*X81 + SQR(X81) >= 0)
@constraint(model, E129, SQR(X72) - 2*X72*X77 + SQR(X77) >= 0)
@constraint(model, E130, SQR(X72) + 2*X72*X77 + SQR(X77) >= 0)
@constraint(model, E131, SQR(X75) - 2*X75*X77 + SQR(X77) >= 0)
@constraint(model, E132, SQR(X75) + 2*X75*X77 + SQR(X77) >= 0)
@constraint(model, E133, SQR(X77) - 2*X77*X81 + SQR(X81) >= 0)
@constraint(model, E134, SQR(X77) + 2*X77*X81 + SQR(X81) >= 0)

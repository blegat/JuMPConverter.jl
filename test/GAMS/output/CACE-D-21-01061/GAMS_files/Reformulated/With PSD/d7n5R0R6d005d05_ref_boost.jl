...
@constraint(model, E50, - 2*X6 + SQR(X6) >= -1)
@constraint(model, E51, 2*X6 + SQR(X6) >= -1)
@constraint(model, E52, - 2*X8 + SQR(X8) >= -1)
@constraint(model, E53, 2*X8 + SQR(X8) >= -1)
@constraint(model, E54, - 2*X9 + SQR(X9) >= -1)
@constraint(model, E55, 2*X9 + SQR(X9) >= -1)
@constraint(model, E56, - 2*X10 + SQR(X10) >= -1)
@constraint(model, E57, 2*X10 + SQR(X10) >= -1)
@constraint(model, E58, - 2*X20 + SQR(X20) >= -1)
@constraint(model, E59, 2*X20 + SQR(X20) >= -1)
@constraint(model, E60, - 2*X21 + SQR(X21) >= -1)
@constraint(model, E61, 2*X21 + SQR(X21) >= -1)
@constraint(model, E62, - 2*X22 + SQR(X22) >= -1)
@constraint(model, E63, 2*X22 + SQR(X22) >= -1)
@constraint(model, E64, - 2*X24 + SQR(X24) >= -1)
@constraint(model, E65, 2*X24 + SQR(X24) >= -1)
@constraint(model, E66, - 2*X25 + SQR(X25) >= -1)
@constraint(model, E67, 2*X25 + SQR(X25) >= -1)
@constraint(model, E68, - 2*X26 + SQR(X26) >= -1)
@constraint(model, E69, 2*X26 + SQR(X26) >= -1)
@constraint(model, E70, - 2*X27 + SQR(X27) >= -1)
@constraint(model, E71, 2*X27 + SQR(X27) >= -1)
@constraint(model, E72, - 2*X28 + SQR(X28) >= -1)
@constraint(model, E73, 2*X28 + SQR(X28) >= -1)
@constraint(model, E74, - 2*X32 + SQR(X32) >= -1)
@constraint(model, E75, 2*X32 + SQR(X32) >= -1)
@constraint(model, E76, - 2*X35 + SQR(X35) >= -1)
@constraint(model, E77, 2*X35 + SQR(X35) >= -1)
@constraint(model, E78, - 2*X36 + SQR(X36) >= -1)
@constraint(model, E79, 2*X36 + SQR(X36) >= -1)
@constraint(model, E80, - 2*X37 + SQR(X37) >= -1)
@constraint(model, E81, 2*X37 + SQR(X37) >= -1)
@constraint(model, E82, - 2*X42 + SQR(X42) >= -1)
@constraint(model, E83, 2*X42 + SQR(X42) >= -1)
@constraint(model, E84, - 2*X43 + SQR(X43) >= -1)
@constraint(model, E85, 2*X43 + SQR(X43) >= -1)
@constraint(model, E86, - 2*X44 + SQR(X44) >= -1)
@constraint(model, E87, 2*X44 + SQR(X44) >= -1)
@constraint(model, E88, SQR(X6) - 2*X6*X8 + SQR(X8) >= 0)
@constraint(model, E89, SQR(X6) + 2*X6*X8 + SQR(X8) >= 0)
@constraint(model, E90, SQR(X6) - 2*X6*X9 + SQR(X9) >= 0)
@constraint(model, E91, SQR(X6) + 2*X6*X9 + SQR(X9) >= 0)
@constraint(model, E92, SQR(X6) - 2*X6*X10 + SQR(X10) >= 0)
@constraint(model, E93, SQR(X6) + 2*X6*X10 + SQR(X10) >= 0)
@constraint(model, E94, SQR(X6) - 2*X6*X20 + SQR(X20) >= 0)
@constraint(model, E95, SQR(X6) + 2*X6*X20 + SQR(X20) >= 0)
@constraint(model, E96, SQR(X6) - 2*X6*X27 + SQR(X27) >= 0)
@constraint(model, E97, SQR(X6) + 2*X6*X27 + SQR(X27) >= 0)
@constraint(model, E98, SQR(X6) - 2*X6*X36 + SQR(X36) >= 0)
@constraint(model, E99, SQR(X6) + 2*X6*X36 + SQR(X36) >= 0)
@constraint(model, E100, SQR(X6) - 2*X6*X42 + SQR(X42) >= 0)
@constraint(model, E101, SQR(X6) + 2*X6*X42 + SQR(X42) >= 0)
@constraint(model, E102, SQR(X8) - 2*X8*X9 + SQR(X9) >= 0)
@constraint(model, E103, SQR(X8) + 2*X8*X9 + SQR(X9) >= 0)
@constraint(model, E104, SQR(X8) - 2*X8*X27 + SQR(X27) >= 0)
@constraint(model, E105, SQR(X8) + 2*X8*X27 + SQR(X27) >= 0)
@constraint(model, E106, SQR(X8) - 2*X8*X28 + SQR(X28) >= 0)
@constraint(model, E107, SQR(X8) + 2*X8*X28 + SQR(X28) >= 0)
@constraint(model, E108, SQR(X9) - 2*X9*X10 + SQR(X10) >= 0)
@constraint(model, E109, SQR(X9) + 2*X9*X10 + SQR(X10) >= 0)
@constraint(model, E110, SQR(X9) - 2*X9*X27 + SQR(X27) >= 0)
@constraint(model, E111, SQR(X9) + 2*X9*X27 + SQR(X27) >= 0)
@constraint(model, E112, SQR(X9) - 2*X9*X42 + SQR(X42) >= 0)
@constraint(model, E113, SQR(X9) + 2*X9*X42 + SQR(X42) >= 0)
@constraint(model, E114, SQR(X10) - 2*X10*X44 + SQR(X44) >= 0)
@constraint(model, E115, SQR(X10) + 2*X10*X44 + SQR(X44) >= 0)
@constraint(model, E116, SQR(X21) - 2*X21*X37 + SQR(X37) >= 0)
@constraint(model, E117, SQR(X21) + 2*X21*X37 + SQR(X37) >= 0)
@constraint(model, E118, SQR(X28) - 2*X28*X42 + SQR(X42) >= 0)
@constraint(model, E119, SQR(X28) + 2*X28*X42 + SQR(X42) >= 0)
@constraint(model, E120, SQR(X37) - 2*X37*X43 + SQR(X43) >= 0)
@constraint(model, E121, SQR(X37) + 2*X37*X43 + SQR(X43) >= 0)
@constraint(model, E122, objvar == X0)

...
@constraint(model, E74, 2*X13 + SQR(X13) >= -1)
@constraint(model, E75, - 2*X15 + SQR(X15) >= -1)
@constraint(model, E76, 2*X15 + SQR(X15) >= -1)
@constraint(model, E77, - 2*X16 + SQR(X16) >= -1)
@constraint(model, E78, 2*X16 + SQR(X16) >= -1)
@constraint(model, E79, - 2*X17 + SQR(X17) >= -1)
@constraint(model, E80, 2*X17 + SQR(X17) >= -1)
@constraint(model, E81, - 2*X61 + SQR(X61) >= -1)
...
@constraint(model, E87, - 2*X77 + SQR(X77) >= -1)
@constraint(model, E88, 2*X77 + SQR(X77) >= -1)
@constraint(model, E89, - 2*X79 + SQR(X79) >= -1)
@constraint(model, E90, 2*X79 + SQR(X79) >= -1)
@constraint(model, E91, - 2*X84 + SQR(X84) >= -1)
@constraint(model, E92, 2*X84 + SQR(X84) >= -1)
@constraint(model, E93, - 2*X85 + SQR(X85) >= -1)
@constraint(model, E94, 2*X85 + SQR(X85) >= -1)
@constraint(model, E95, SQR(X10) - 2*X10*X11 + SQR(X11) >= 0)
@constraint(model, E96, SQR(X10) + 2*X10*X11 + SQR(X11) >= 0)
@constraint(model, E97, SQR(X10) - 2*X10*X12 + SQR(X12) >= 0)
@constraint(model, E98, SQR(X10) + 2*X10*X12 + SQR(X12) >= 0)
@constraint(model, E99, SQR(X10) - 2*X10*X13 + SQR(X13) >= 0)
@constraint(model, E100, SQR(X10) + 2*X10*X13 + SQR(X13) >= 0)
@constraint(model, E101, SQR(X10) - 2*X10*X15 + SQR(X15) >= 0)
@constraint(model, E102, SQR(X10) + 2*X10*X15 + SQR(X15) >= 0)
@constraint(model, E103, SQR(X10) - 2*X10*X16 + SQR(X16) >= 0)
@constraint(model, E104, SQR(X10) + 2*X10*X16 + SQR(X16) >= 0)
@constraint(model, E105, SQR(X10) - 2*X10*X17 + SQR(X17) >= 0)
@constraint(model, E106, SQR(X10) + 2*X10*X17 + SQR(X17) >= 0)
@constraint(model, E107, SQR(X10) - 2*X10*X85 + SQR(X85) >= 0)
@constraint(model, E108, SQR(X10) + 2*X10*X85 + SQR(X85) >= 0)
@constraint(model, E109, SQR(X11) - 2*X11*X12 + SQR(X12) >= 0)
@constraint(model, E110, SQR(X11) + 2*X11*X12 + SQR(X12) >= 0)
@constraint(model, E111, SQR(X11) - 2*X11*X13 + SQR(X13) >= 0)
@constraint(model, E112, SQR(X11) + 2*X11*X13 + SQR(X13) >= 0)
@constraint(model, E113, SQR(X11) - 2*X11*X15 + SQR(X15) >= 0)
@constraint(model, E114, SQR(X11) + 2*X11*X15 + SQR(X15) >= 0)
@constraint(model, E115, SQR(X11) - 2*X11*X17 + SQR(X17) >= 0)
@constraint(model, E116, SQR(X11) + 2*X11*X17 + SQR(X17) >= 0)
@constraint(model, E117, SQR(X11) - 2*X11*X79 + SQR(X79) >= 0)
@constraint(model, E118, SQR(X11) + 2*X11*X79 + SQR(X79) >= 0)
@constraint(model, E119, SQR(X12) - 2*X12*X15 + SQR(X15) >= 0)
@constraint(model, E120, SQR(X12) + 2*X12*X15 + SQR(X15) >= 0)
@constraint(model, E121, SQR(X12) - 2*X12*X16 + SQR(X16) >= 0)
@constraint(model, E122, SQR(X12) + 2*X12*X16 + SQR(X16) >= 0)
@constraint(model, E123, SQR(X12) - 2*X12*X85 + SQR(X85) >= 0)
@constraint(model, E124, SQR(X12) + 2*X12*X85 + SQR(X85) >= 0)
@constraint(model, E125, SQR(X13) - 2*X13*X15 + SQR(X15) >= 0)
@constraint(model, E126, SQR(X13) + 2*X13*X15 + SQR(X15) >= 0)
@constraint(model, E127, SQR(X13) - 2*X13*X16 + SQR(X16) >= 0)
@constraint(model, E128, SQR(X13) + 2*X13*X16 + SQR(X16) >= 0)
@constraint(model, E129, SQR(X13) - 2*X13*X17 + SQR(X17) >= 0)
@constraint(model, E130, SQR(X13) + 2*X13*X17 + SQR(X17) >= 0)
@constraint(model, E131, SQR(X15) - 2*X15*X16 + SQR(X16) >= 0)
@constraint(model, E132, SQR(X15) + 2*X15*X16 + SQR(X16) >= 0)
@constraint(model, E133, SQR(X16) - 2*X16*X17 + SQR(X17) >= 0)
@constraint(model, E134, SQR(X16) + 2*X16*X17 + SQR(X17) >= 0)
@constraint(model, E135, SQR(X17) - 2*X17*X85 + SQR(X85) >= 0)
@constraint(model, E136, SQR(X17) + 2*X17*X85 + SQR(X85) >= 0)
@constraint(model, E137, SQR(X61) - 2*X61*X79 + SQR(X79) >= 0)
@constraint(model, E138, SQR(X61) + 2*X61*X79 + SQR(X79) >= 0)
@constraint(model, E139, SQR(X69) - 2*X69*X77 + SQR(X77) >= 0)
@constraint(model, E140, SQR(X69) + 2*X69*X77 + SQR(X77) >= 0)
@constraint(model, E141, objvar == X0)

...
@constraint(model, E72, - 2*X12 + SQR(X12) >= -1)
@constraint(model, E73, 2*X12 + SQR(X12) >= -1)
@constraint(model, E74, - 2*X41 + SQR(X41) >= -1)
@constraint(model, E75, 2*X41 + SQR(X41) >= -1)
...
@constraint(model, E90, - 2*X57 + SQR(X57) >= -1)
@constraint(model, E91, 2*X57 + SQR(X57) >= -1)
@constraint(model, E92, - 2*X58 + SQR(X58) >= -1)
@constraint(model, E93, 2*X58 + SQR(X58) >= -1)
@constraint(model, E94, - 2*X59 + SQR(X59) >= -1)
@constraint(model, E95, 2*X59 + SQR(X59) >= -1)
@constraint(model, E96, - 2*X60 + SQR(X60) >= -1)
@constraint(model, E97, 2*X60 + SQR(X60) >= -1)
@constraint(model, E98, - 2*X65 + SQR(X65) >= -1)
@constraint(model, E99, 2*X65 + SQR(X65) >= -1)
@constraint(model, E100, - 2*X67 + SQR(X67) >= -1)
@constraint(model, E101, 2*X67 + SQR(X67) >= -1)
@constraint(model, E102, - 2*X71 + SQR(X71) >= -1)
@constraint(model, E103, 2*X71 + SQR(X71) >= -1)
...
@constraint(model, E112, SQR(X7) - 2*X7*X12 + SQR(X12) >= 0)
@constraint(model, E113, SQR(X7) + 2*X7*X12 + SQR(X12) >= 0)
@constraint(model, E114, SQR(X7) - 2*X7*X44 + SQR(X44) >= 0)
@constraint(model, E115, SQR(X7) + 2*X7*X44 + SQR(X44) >= 0)
@constraint(model, E116, SQR(X7) - 2*X7*X51 + SQR(X51) >= 0)
@constraint(model, E117, SQR(X7) + 2*X7*X51 + SQR(X51) >= 0)
@constraint(model, E118, SQR(X7) - 2*X7*X59 + SQR(X59) >= 0)
@constraint(model, E119, SQR(X7) + 2*X7*X59 + SQR(X59) >= 0)
@constraint(model, E120, SQR(X7) - 2*X7*X67 + SQR(X67) >= 0)
@constraint(model, E121, SQR(X7) + 2*X7*X67 + SQR(X67) >= 0)
@constraint(model, E122, SQR(X8) - 2*X8*X9 + SQR(X9) >= 0)
@constraint(model, E123, SQR(X8) + 2*X8*X9 + SQR(X9) >= 0)
@constraint(model, E124, SQR(X8) - 2*X8*X10 + SQR(X10) >= 0)
@constraint(model, E125, SQR(X8) + 2*X8*X10 + SQR(X10) >= 0)
@constraint(model, E126, SQR(X8) - 2*X8*X12 + SQR(X12) >= 0)
@constraint(model, E127, SQR(X8) + 2*X8*X12 + SQR(X12) >= 0)
@constraint(model, E128, SQR(X8) - 2*X8*X51 + SQR(X51) >= 0)
@constraint(model, E129, SQR(X8) + 2*X8*X51 + SQR(X51) >= 0)
@constraint(model, E130, SQR(X8) - 2*X8*X58 + SQR(X58) >= 0)
@constraint(model, E131, SQR(X8) + 2*X8*X58 + SQR(X58) >= 0)
@constraint(model, E132, SQR(X9) - 2*X9*X10 + SQR(X10) >= 0)
@constraint(model, E133, SQR(X9) + 2*X9*X10 + SQR(X10) >= 0)
@constraint(model, E134, SQR(X9) - 2*X9*X11 + SQR(X11) >= 0)
@constraint(model, E135, SQR(X9) + 2*X9*X11 + SQR(X11) >= 0)
@constraint(model, E136, SQR(X9) - 2*X9*X12 + SQR(X12) >= 0)
@constraint(model, E137, SQR(X9) + 2*X9*X12 + SQR(X12) >= 0)
...
@constraint(model, E141, SQR(X10) + 2*X10*X12 + SQR(X12) >= 0)
@constraint(model, E142, SQR(X10) - 2*X10*X58 + SQR(X58) >= 0)
@constraint(model, E143, SQR(X10) + 2*X10*X58 + SQR(X58) >= 0)
@constraint(model, E144, SQR(X10) - 2*X10*X59 + SQR(X59) >= 0)
@constraint(model, E145, SQR(X10) + 2*X10*X59 + SQR(X59) >= 0)
@constraint(model, E146, SQR(X10) - 2*X10*X71 + SQR(X71) >= 0)
@constraint(model, E147, SQR(X10) + 2*X10*X71 + SQR(X71) >= 0)
@constraint(model, E148, SQR(X11) - 2*X11*X12 + SQR(X12) >= 0)
@constraint(model, E149, SQR(X11) + 2*X11*X12 + SQR(X12) >= 0)
@constraint(model, E150, SQR(X12) - 2*X12*X47 + SQR(X47) >= 0)
@constraint(model, E151, SQR(X12) + 2*X12*X47 + SQR(X47) >= 0)
@constraint(model, E152, SQR(X12) - 2*X12*X65 + SQR(X65) >= 0)
@constraint(model, E153, SQR(X12) + 2*X12*X65 + SQR(X65) >= 0)
@constraint(model, E154, SQR(X41) - 2*X41*X50 + SQR(X50) >= 0)
@constraint(model, E155, SQR(X41) + 2*X41*X50 + SQR(X50) >= 0)
@constraint(model, E156, SQR(X44) - 2*X44*X51 + SQR(X51) >= 0)
@constraint(model, E157, SQR(X44) + 2*X44*X51 + SQR(X51) >= 0)
@constraint(model, E158, SQR(X46) - 2*X46*X57 + SQR(X57) >= 0)
@constraint(model, E159, SQR(X46) + 2*X46*X57 + SQR(X57) >= 0)
@constraint(model, E160, SQR(X46) - 2*X46*X71 + SQR(X71) >= 0)
@constraint(model, E161, SQR(X46) + 2*X46*X71 + SQR(X71) >= 0)
@constraint(model, E162, SQR(X47) - 2*X47*X57 + SQR(X57) >= 0)
@constraint(model, E163, SQR(X47) + 2*X47*X57 + SQR(X57) >= 0)
@constraint(model, E164, SQR(X47) - 2*X47*X58 + SQR(X58) >= 0)
@constraint(model, E165, SQR(X47) + 2*X47*X58 + SQR(X58) >= 0)
@constraint(model, E166, SQR(X50) - 2*X50*X59 + SQR(X59) >= 0)
@constraint(model, E167, SQR(X50) + 2*X50*X59 + SQR(X59) >= 0)
@constraint(model, E168, SQR(X57) - 2*X57*X65 + SQR(X65) >= 0)
@constraint(model, E169, SQR(X57) + 2*X57*X65 + SQR(X65) >= 0)

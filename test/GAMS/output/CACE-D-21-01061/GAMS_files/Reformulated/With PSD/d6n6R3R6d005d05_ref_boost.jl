...
@constraint(model, E50, - 2*X9 + SQR(X9) >= -1)
@constraint(model, E51, 2*X9 + SQR(X9) >= -1)
@constraint(model, E52, - 2*X10 + SQR(X10) >= -1)
@constraint(model, E53, 2*X10 + SQR(X10) >= -1)
@constraint(model, E54, - 2*X11 + SQR(X11) >= -1)
@constraint(model, E55, 2*X11 + SQR(X11) >= -1)
@constraint(model, E56, - 2*X12 + SQR(X12) >= -1)
@constraint(model, E57, 2*X12 + SQR(X12) >= -1)
@constraint(model, E58, - 2*X13 + SQR(X13) >= -1)
@constraint(model, E59, 2*X13 + SQR(X13) >= -1)
@constraint(model, E60, - 2*X41 + SQR(X41) >= -1)
@constraint(model, E61, 2*X41 + SQR(X41) >= -1)
@constraint(model, E62, - 2*X42 + SQR(X42) >= -1)
@constraint(model, E63, 2*X42 + SQR(X42) >= -1)
@constraint(model, E64, - 2*X44 + SQR(X44) >= -1)
@constraint(model, E65, 2*X44 + SQR(X44) >= -1)
@constraint(model, E66, - 2*X46 + SQR(X46) >= -1)
@constraint(model, E67, 2*X46 + SQR(X46) >= -1)
@constraint(model, E68, - 2*X47 + SQR(X47) >= -1)
@constraint(model, E69, 2*X47 + SQR(X47) >= -1)
@constraint(model, E70, - 2*X48 + SQR(X48) >= -1)
@constraint(model, E71, 2*X48 + SQR(X48) >= -1)
@constraint(model, E72, - 2*X50 + SQR(X50) >= -1)
@constraint(model, E73, 2*X50 + SQR(X50) >= -1)
@constraint(model, E74, - 2*X51 + SQR(X51) >= -1)
@constraint(model, E75, 2*X51 + SQR(X51) >= -1)
@constraint(model, E76, - 2*X54 + SQR(X54) >= -1)
@constraint(model, E77, 2*X54 + SQR(X54) >= -1)
@constraint(model, E78, - 2*X55 + SQR(X55) >= -1)
@constraint(model, E79, 2*X55 + SQR(X55) >= -1)
@constraint(model, E80, - 2*X57 + SQR(X57) >= -1)
@constraint(model, E81, 2*X57 + SQR(X57) >= -1)
@constraint(model, E82, - 2*X61 + SQR(X61) >= -1)
@constraint(model, E83, 2*X61 + SQR(X61) >= -1)
@constraint(model, E84, - 2*X62 + SQR(X62) >= -1)
@constraint(model, E85, 2*X62 + SQR(X62) >= -1)
@constraint(model, E86, - 2*X65 + SQR(X65) >= -1)
@constraint(model, E87, 2*X65 + SQR(X65) >= -1)
@constraint(model, E88, SQR(X9) - 2*X9*X10 + SQR(X10) >= 0)
@constraint(model, E89, SQR(X9) + 2*X9*X10 + SQR(X10) >= 0)
@constraint(model, E90, SQR(X9) - 2*X9*X11 + SQR(X11) >= 0)
@constraint(model, E91, SQR(X9) + 2*X9*X11 + SQR(X11) >= 0)
@constraint(model, E92, SQR(X9) - 2*X9*X12 + SQR(X12) >= 0)
@constraint(model, E93, SQR(X9) + 2*X9*X12 + SQR(X12) >= 0)
@constraint(model, E94, SQR(X9) - 2*X9*X48 + SQR(X48) >= 0)
@constraint(model, E95, SQR(X9) + 2*X9*X48 + SQR(X48) >= 0)
@constraint(model, E96, SQR(X9) - 2*X9*X50 + SQR(X50) >= 0)
@constraint(model, E97, SQR(X9) + 2*X9*X50 + SQR(X50) >= 0)
@constraint(model, E98, SQR(X9) - 2*X9*X51 + SQR(X51) >= 0)
@constraint(model, E99, SQR(X9) + 2*X9*X51 + SQR(X51) >= 0)
@constraint(model, E100, SQR(X9) - 2*X9*X57 + SQR(X57) >= 0)
@constraint(model, E101, SQR(X9) + 2*X9*X57 + SQR(X57) >= 0)
@constraint(model, E102, SQR(X10) - 2*X10*X11 + SQR(X11) >= 0)
@constraint(model, E103, SQR(X10) + 2*X10*X11 + SQR(X11) >= 0)
@constraint(model, E104, SQR(X10) - 2*X10*X12 + SQR(X12) >= 0)
@constraint(model, E105, SQR(X10) + 2*X10*X12 + SQR(X12) >= 0)
@constraint(model, E106, SQR(X10) - 2*X10*X13 + SQR(X13) >= 0)
@constraint(model, E107, SQR(X10) + 2*X10*X13 + SQR(X13) >= 0)
@constraint(model, E108, SQR(X11) - 2*X11*X12 + SQR(X12) >= 0)
@constraint(model, E109, SQR(X11) + 2*X11*X12 + SQR(X12) >= 0)
@constraint(model, E110, SQR(X11) - 2*X11*X13 + SQR(X13) >= 0)
@constraint(model, E111, SQR(X11) + 2*X11*X13 + SQR(X13) >= 0)
@constraint(model, E112, SQR(X12) - 2*X12*X13 + SQR(X13) >= 0)
@constraint(model, E113, SQR(X12) + 2*X12*X13 + SQR(X13) >= 0)
@constraint(model, E114, SQR(X12) - 2*X12*X57 + SQR(X57) >= 0)
@constraint(model, E115, SQR(X12) + 2*X12*X57 + SQR(X57) >= 0)
@constraint(model, E116, SQR(X13) - 2*X13*X61 + SQR(X61) >= 0)
@constraint(model, E117, SQR(X13) + 2*X13*X61 + SQR(X61) >= 0)
@constraint(model, E118, SQR(X44) - 2*X44*X54 + SQR(X54) >= 0)
@constraint(model, E119, SQR(X44) + 2*X44*X54 + SQR(X54) >= 0)
@constraint(model, E120, SQR(X44) - 2*X44*X55 + SQR(X55) >= 0)
@constraint(model, E121, SQR(X44) + 2*X44*X55 + SQR(X55) >= 0)
@constraint(model, E122, SQR(X46) - 2*X46*X47 + SQR(X47) >= 0)
@constraint(model, E123, SQR(X46) + 2*X46*X47 + SQR(X47) >= 0)
@constraint(model, E124, SQR(X46) - 2*X46*X50 + SQR(X50) >= 0)
@constraint(model, E125, SQR(X46) + 2*X46*X50 + SQR(X50) >= 0)
@constraint(model, E126, SQR(X47) - 2*X47*X54 + SQR(X54) >= 0)
@constraint(model, E127, SQR(X47) + 2*X47*X54 + SQR(X54) >= 0)
@constraint(model, E128, SQR(X48) - 2*X48*X55 + SQR(X55) >= 0)
@constraint(model, E129, SQR(X48) + 2*X48*X55 + SQR(X55) >= 0)
@constraint(model, E130, SQR(X51) - 2*X51*X55 + SQR(X55) >= 0)
@constraint(model, E131, SQR(X51) + 2*X51*X55 + SQR(X55) >= 0)
@constraint(model, E132, objvar == X0)
